...
pub(crate) mod marshal {
    ...
    use crate::consensus::{application::Application, block::Block};
    ...
    pub(crate) type Marshaled<TContext> = commonware_consensus::application::marshaled::Marshaled<
        TContext,
        Scheme<PublicKey, MinSig>,
        Application<TContext>,
        Block,
    >;
}
