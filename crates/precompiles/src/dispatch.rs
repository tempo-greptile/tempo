//! Tempo precompile dispatcher helper methods and macros.

use crate::{
    IntoPrecompileResult, Result, TIP20_FACTORY_ADDRESS, TIP403_REGISTRY_ADDRESS,
