...
mod tests {
    ...
    test_precompile!(set_validator_token, |admin, validator| {
    ...
    test_precompile!(set_validator_token_zero_address, |validator| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(set_user_token, |admin, user| {
        let token = TIP20Builder::new("TestToken", "TST", admin).build()?;
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(set_user_token_zero_address, |user| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(get_pool_id, |token_a, token_b, sender| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(tip_fee_amm_pool_operations, |token_a, token_b, sender| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(pool_id_calculation, |token_a, token_b, sender| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(fee_manager_invalid_token_error, |user, validator| {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(tip_fee_manager_test_selector_coverage, || {
        let mut fee_manager = TipFeeManager::new();
    ...
    test_precompile!(mint_with_validator_token, |admin, user| {
        ...
        let initial_supply_result = fee_manager.call(&initial_supply_call.abi_encode(), user)?;
    ...
    test_precompile!(
        unknown_selector_error_pre_moderato,
    ...
    test_precompile!(
        unknown_selector_error_post_moderato,
