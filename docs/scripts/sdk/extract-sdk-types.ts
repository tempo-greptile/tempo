 ...
 *
 * Usage:
 *   bun scripts/sdk/extract-sdk-types.ts <module> <function>
 *
 * Examples:
 *   bun scripts/sdk/extract-sdk-types.ts token transfer
 *   bun scripts/sdk/extract-sdk-types.ts token getBalance
 *
 * Output:
 *   Writes JSON to snippets/sdk/types/<module>.<function>.json
 */
...
// Output directory
const outputDir = path.join(process.cwd(), 'snippets/sdk/types')
