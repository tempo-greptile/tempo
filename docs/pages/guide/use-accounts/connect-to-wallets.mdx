---
mipd: true
title: "Connect to Wallets • Tempo"
description: "It is possible to use Tempo with EVM-compatible wallets that support the Tempo network, or support adding custom networks (like MetaMask)."
---
