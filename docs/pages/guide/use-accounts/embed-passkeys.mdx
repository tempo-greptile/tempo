---
title: "Embed Passkey Accounts • Tempo"
description: "Create a domain-bound passkey account on Tempo using WebAuthn signatures for secure, passwordless authentication with Tempo transactions."
---
