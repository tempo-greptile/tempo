---
title: "Mint Stablecoins • Tempo"
description: "Create new tokens by minting them to a specified address."
---
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Burn 100 tokens from your own balance
    token // [!code focus]
        .burn(treasury_address, U256::from(100_000_000)) // [!code focus]
        .send() // [!code focus]
        .await?; // [!code focus]
