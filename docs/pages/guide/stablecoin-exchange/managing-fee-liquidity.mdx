---
title: "Managing Fee Liquidity • Tempo"
description: "The Fee AMM converts transaction fees between stablecoins when users pay in a different token than the validator prefers."
---
