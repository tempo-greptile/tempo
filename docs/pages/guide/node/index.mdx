---
title: "Tempo Node • Tempo"
description: "Running a Tempo node allows you to interact with the network directly, providing your own RPC access or contributing to network infrastructure."
---
