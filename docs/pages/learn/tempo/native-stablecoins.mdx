---
title: "TIP-20 Tokens • Tempo"
description: "Tempo extends the ERC-20 standard used on EVM chains (Ethereum, Base, Arbitrum) with additional features, and enshrines them in protocol as the TIP-20 contract."
---
