...
import TokenBurnBlockedParams from '../../../../../snippets/sdk/params/token.burnBlocked.wagmi.mdx'
import TokenBurnBlockedReturns from '../../../../../snippets/sdk/returns/token.burnBlocked.mdx'

# `token.burnBlocked`

Burns TIP-20 tokens from a blocked address. Requires the `BURN_BLOCKED` role. [Learn more about token roles](/protocol/tip403/spec)
...
<TokenBurnBlockedReturns />

## Parameters

<TokenBurnBlockedParams />
