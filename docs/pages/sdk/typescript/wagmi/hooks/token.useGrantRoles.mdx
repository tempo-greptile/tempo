---
title: "Token.useGrantRoles • Tempo"
description: "Grants roles to an address for a TIP-20 token."
---
...
Grants roles to an address for a TIP-20 token. Requires appropriate permissions. [Learn more about token roles](/protocol/tip403/spec)
...
See [Wagmi Action `token.grantRoles` Return Type](/sdk/typescript/wagmi/actions/token.grantRoles#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.grantRoles` Parameters](/sdk/typescript/wagmi/actions/token.grantRoles#parameters)
