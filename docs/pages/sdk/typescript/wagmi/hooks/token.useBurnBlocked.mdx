---
title: "Token.useBurnBlocked • Tempo"
description: "Burns blocked TIP-20 tokens from a specific address."
---
...
See [Wagmi Action `token.burnBlocked` Return Type](/sdk/typescript/wagmi/actions/token.burnBlocked#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.burnBlocked` Parameters](/sdk/typescript/wagmi/actions/token.burnBlocked#parameters)
