---
title: "Policy.useModifyWhitelist • Tempo"
description: "Modifies the whitelist for a whitelist-type transfer policy."
---
...
See [Wagmi Action `policy.modifyWhitelist` Return Type](/sdk/typescript/wagmi/actions/policy.modifyWhitelist#return-type)

### mutate/mutateAsync

See [Wagmi Action `policy.modifyWhitelist` Parameters](/sdk/typescript/wagmi/actions/policy.modifyWhitelist#parameters)
