---
title: "Token.useChangeTransferPolicy • Tempo"
...
See [Wagmi Action `token.changeTransferPolicy` Return Type](/sdk/typescript/wagmi/actions/token.changeTransferPolicy#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.changeTransferPolicy` Parameters](/sdk/typescript/wagmi/actions/token.changeTransferPolicy#parameters)
