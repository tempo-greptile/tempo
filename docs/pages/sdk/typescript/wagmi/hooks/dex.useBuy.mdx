---
title: "Dex.useBuy • Tempo"
description: "Buys a specific amount of tokens from the Stablecoin DEX orderbook."
---
...
const { data: result, mutate } = Hooks.dex.useBuySync()
...
const { data: hash, mutate } = Hooks.dex.useBuy()
...
See [Wagmi Action `dex.buy` Return Type](/sdk/typescript/wagmi/actions/dex.buy#return-type)

### mutate/mutateAsync

See [Wagmi Action `dex.buy` Parameters](/sdk/typescript/wagmi/actions/dex.buy#parameters)
