---
title: "Fee.useUserToken • Tempo"
description: "Gets the user's default fee token preference."
---
...
Gets the user's default fee token preference. [Learn more about fees](/protocol/fees)
...
See [Wagmi Action `fee.getUserToken` Return Type](/sdk/typescript/wagmi/actions/fee.getUserToken#return-type)

## Parameters

See [Wagmi Action `fee.getUserToken` Parameters](/sdk/typescript/wagmi/actions/fee.getUserToken#parameters)
