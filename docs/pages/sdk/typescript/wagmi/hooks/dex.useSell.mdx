---
title: "Dex.useSell • Tempo"
description: "Sells a specific amount of tokens on the Stablecoin DEX orderbook."
---
...
See [Wagmi Action `dex.sell` Return Type](/sdk/typescript/wagmi/actions/dex.sell#return-type)

### mutate/mutateAsync

See [Wagmi Action `dex.sell` Parameters](/sdk/typescript/wagmi/actions/dex.sell#parameters)
