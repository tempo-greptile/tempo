---
title: "Faucet.useFund • Tempo"
description: "Hook for funding an account with testnet tokens on Tempo's testnet."
---
...
See [Wagmi Action `faucet.fund` Return Type](/sdk/typescript/wagmi/actions/faucet.fund#return-type)

### mutate/mutateAsync

See [Wagmi Action `faucet.fund` Parameters](/sdk/typescript/wagmi/actions/faucet.fund#parameters)
