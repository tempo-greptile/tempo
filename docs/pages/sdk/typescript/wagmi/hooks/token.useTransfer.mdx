---
title: "Token.useTransfer • Tempo"
description: "Transfers TIP-20 tokens from the caller to a recipient."
---
...
See [Wagmi Action `token.transfer` Return Type](/sdk/typescript/wagmi/actions/token.transfer#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.transfer` Parameters](/sdk/typescript/wagmi/actions/token.transfer#parameters)
