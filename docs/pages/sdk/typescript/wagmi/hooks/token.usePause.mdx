---
title: "Token.usePause • Tempo"
description: "Pauses a TIP-20 token, preventing transfers."
---
...
const { data: result, mutate } = Hooks.token.usePauseSync()
...
const { data: hash, mutate } = Hooks.token.usePause()
...
See [Wagmi Action `token.pause` Return Type](/sdk/typescript/wagmi/actions/token.pause#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.pause` Parameters](/sdk/typescript/wagmi/actions/token.pause#parameters)
