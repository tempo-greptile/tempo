---
title: "Amm.useRebalanceSwap • Tempo"
description: "Performs a rebalance swap between user and validator tokens."
---
...
const { data: result, mutate } = Hooks.amm.useRebalanceSwapSync()
...
const { data: hash, mutate } = Hooks.amm.useRebalanceSwap()
...
See [Wagmi Action `amm.rebalanceSwap` Return Type](/sdk/typescript/wagmi/actions/amm.rebalanceSwap#return-type)

### mutate/mutateAsync

See [Wagmi Action `amm.rebalanceSwap` Parameters](/sdk/typescript/wagmi/actions/amm.rebalanceSwap#parameters)
