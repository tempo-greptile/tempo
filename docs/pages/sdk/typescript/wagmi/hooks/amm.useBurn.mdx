---
title: "Amm.useBurn • Tempo"
description: "Burns liquidity tokens and receives the underlying token pair."
---
...
Burns liquidity tokens and receives the underlying token pair. [Learn more about the Fee AMM](/protocol/fees/spec-fee-amm)
...
See [Wagmi Action `amm.burn` Return Type](/sdk/typescript/wagmi/actions/amm.burn#return-type)

### mutate/mutateAsync

See [Wagmi Action `amm.burn` Parameters](/sdk/typescript/wagmi/actions/amm.burn#parameters)
