---
title: "Dex.useWithdraw • Tempo"
description: "Withdraws tokens from the Stablecoin DEX to your wallet."
---
...
See [Wagmi Action `dex.withdraw` Return Type](/sdk/typescript/wagmi/actions/dex.withdraw#return-type)

### mutate/mutateAsync

See [Wagmi Action `dex.withdraw` Parameters](/sdk/typescript/wagmi/actions/dex.withdraw#parameters)
