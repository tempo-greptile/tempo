---
title: "Token.useUnpause • Tempo"
description: "Unpauses a TIP-20 token, allowing transfers to resume."
---
...
See [Wagmi Action `token.unpause` Return Type](/sdk/typescript/wagmi/actions/token.unpause#return-type)

### mutate/mutateAsync

See [Wagmi Action `token.unpause` Parameters](/sdk/typescript/wagmi/actions/token.unpause#parameters)
