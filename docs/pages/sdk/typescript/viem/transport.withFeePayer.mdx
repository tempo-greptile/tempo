---
title: "WithFeePayer • Tempo"
description: "Creates a transport that routes transactions to a fee payer service when a feePayer is requested on an action."
---
...
Creates a transport that routes transactions to a fee payer service when a `feePayer` is requested on an action. [Learn more about Fee Sponsorship](/protocol/transactions/spec-tempo-transaction)
