---
title: "Account.fromSecp256k1 • Tempo"
description: "Instantiates an Account from a secp256k1 private key (standard Ethereum signature scheme)."
---
...
import { Account, Secp256k1 } from 'tempo.ts/viem'
...
{/* TODO: export in tempo.ts 

### With Persistent Storage

Configure the account with persistent storage for key authorizations:

```ts twoslash
import { Account, Storage } from 'tempo.ts/viem'
