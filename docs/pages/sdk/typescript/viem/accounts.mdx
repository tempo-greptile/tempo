---
title: "Accounts • Tempo"
description: "Tempo.ts provides Viem-compatible Local Accounts that support multiple signature schemes including secp256k1, P256, and WebAuthn (passkeys)."
---
