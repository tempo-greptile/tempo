---
title: "TypeScript SDKs • Tempo"
description: "Tempo distributes TypeScript SDKs for: - Viem: TypeScript interface for EVM blockchains - Wagmi: React Hooks (and reactive primitives) for EVM blockchains."
---
