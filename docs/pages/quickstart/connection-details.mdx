---
mipd: true
title: "Check block height (should be steadily increasing) • Tempo"
description: "You can connect with the Tempo Testnet like you would with any other EVM chain."
---
...
cast block-number --rpc-url https://rpc.testnet.tempo.xyz
```
