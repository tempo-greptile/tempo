---
title: "Use the TIP-20 Standard • Tempo"
...
A TIP-20 token can declare a currency identifier (e.g., `"USD"`, `"EUR"`) that identifies the real-world asset backing the token. This enables proper routing and pricing in Tempo's [stablecoin exchange](/protocol/exchange). USD-denominated TIP-20 tokens can be used to pay transaction fees.
