...
Each validator imported during initialization requires approximately 11 SSTOREs
(validator struct fields, array push, pubkey mapping). This places an upper bound
on the number of validators that can be migrated in a single transaction:
