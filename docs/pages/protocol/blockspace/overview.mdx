---
title: "Blockspace Overview • Tempo"
description: "This specification defines the structure of valid blocks in the Tempo blockchain."
---
...
A valid tempo block must contain the following new system transactions
 ...
 - **Fee Manager (end-of-block 1/3)** — settles block fee accounting.  Detailed specification [here](/protocol/fees/spec-fee-amm).
 - **Stablecoin DEX (end-of-block 2/3)** — settles stablecoin exchange balances. Detailed specification [here](/protocol/exchange/spec).
  - **Subblock Metadata (end-of-block 3/3)** — contains metadata about the sub-blocks included in the block. Detailed specification [here](/protocol/blockspace/sub-block-specification).
