---
title: "Fee AMM Specification • Tempo"
description: "This specification defines a system of one-way Automated Market Makers (AMMs) designed to facilitate gas fee payments from a user using one stablecoin (the."
---
